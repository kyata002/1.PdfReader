...
import com.kyata.pdfreader.view.dialog.DeleteDialog;
import com.kyata.pdfreader.view.dialog.InfoDialog;
import com.kyata.pdfreader.view.dialog.RenameDialog;
...
//        updateList(tempList);
    ...
    private String[] computeProgress(int currentPageReading, int totalPage) {
        ...
        return new String[]{String.valueOf(progress), rs};
