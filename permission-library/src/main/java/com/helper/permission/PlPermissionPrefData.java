...
public class PlPermissionPrefData {
    private static WeakReference<PlPermissionPrefData> instance;
    protected final Context context;
    private final SharedPreferences pref;

    public PlPermissionPrefData(Context context, String name) {
        this.context = context;
        this.pref = context.getSharedPreferences(name, Context.MODE_PRIVATE);
    }

    public static PlPermissionPrefData instance(Context context) {
        if (instance == null || instance.get() == null) {
            instance = new WeakReference<>(new PlPermissionPrefData(context, "ms_permission"));
        }
        return instance.get();
    }
